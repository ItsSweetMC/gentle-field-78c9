...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/gentle-field-78c9
```

A live public deployment of this template is available at [https://gentle-field-78c9.templates.workers.dev](https://gentle-field-78c9.templates.workers.dev)
